...
from .coordinator import CituraDataUpdateCoordinator
...
async def async_setup_entry(
    ...
    coordinator = CituraDataUpdateCoordinator(hass, citura)
...
async def async_migrate_entry(
    ...
    if config_entry.version < 2:
        ...
        hass.config_entries.async_update_entry(
            config_entry, version=2, minor_version=1)
